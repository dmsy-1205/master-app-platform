...
## STEP14-v1 Minimal Service Centers - 2026-06-30

- App Detail Center를 Firebase 앱 메타데이터, Manifest, Version History 표시와 연결했습니다.
- Official App Center에서 Official Badge 및 Featured App 토글을 지원합니다.
- Plugin SDK Generator 초안을 추가하여 manifest.json, permission.json, README.md를 자동 생성합니다.
- Deployment Center에서 Stable / Beta / Rollback 채널 상태를 Firebase에 저장합니다.
- Health Monitor에서 Auth, Database, Runtime, Launcher, Database Collection 상태를 표시합니다.
- Backup Center에서 Users, Apps, Notice, Feedback, Manifest, Approval, ExecutionLogs JSON Export를 지원합니다.
- Developer Center에 앱 등록 전 Manifest / Permission / Entry / Version / Security / Launch Token 검사 기능을 연결했습니다.
- Statistics Dashboard와 Security Scan Center를 관리자 SPA 메뉴에 추가했습니다.
- 모바일 대응을 위해 STEP14 서비스 카드와 테이블형 패널의 반응형 CSS를 추가했습니다.
